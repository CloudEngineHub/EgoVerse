#!/bin/bash
#SBATCH --job-name=scene_diversity_cotrain_4_30
#SBATCH --output=sbatch_logs/scene_diversity_cotrain_4_30.out
#SBATCH --error=sbatch_logs/scene_diversity_cotrain_4_30.err
