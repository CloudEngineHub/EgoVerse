#!/bin/bash
#SBATCH --job-name=scene_diversity_cotrain_8_30
#SBATCH --output=sbatch_logs/scene_diversity_cotrain_8_30.out
#SBATCH --error=sbatch_logs/scene_diversity_cotrain_8_30.err
...
python egomimic/trainHydra.py \
    ...
    data=scene_diversity_cotrain/scene_diversity_cotrain_8_30 \
    ...
    description=scenes-8-time-30-cotrain \
    ckpt_path=/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/fold-clothes-cotrain-2/scenes-8-time-30-cotrain_2026-01-25_22-27-56/checkpoints/last.ckpt
