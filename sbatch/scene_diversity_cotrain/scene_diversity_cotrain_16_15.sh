#!/bin/bash
#SBATCH --job-name=scene_diversity_cotrain_16_15
#SBATCH --output=sbatch_logs/scene_diversity_cotrain_16_15.out
#SBATCH --error=sbatch_logs/scene_diversity_cotrain_16_15.err
...
python egomimic/trainHydra.py \
    ...
    data=scene_diversity_cotrain/scene_diversity_cotrain_16_15 \
    ...
    description=scenes-16-time-15-cotrain \
    ckpt_path=/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/fold-clothes-cotrain/scenes-16-time-15-cotrain_2026-01-23_22-54-37/checkpoints/last.ckpt
