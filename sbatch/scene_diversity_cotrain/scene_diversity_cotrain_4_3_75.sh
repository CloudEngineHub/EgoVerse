#!/bin/bash
#SBATCH --job-name=scene_diversity_cotrain_4_3_75
#SBATCH --output=sbatch_logs/scene_diversity_cotrain_4_3_75.out
#SBATCH --error=sbatch_logs/scene_diversity_cotrain_4_3_75.err
...
python egomimic/trainHydra.py \
    ...
    data=scene_diversity_cotrain/scene_diversity_cotrain_4_3_75 \
    ...
    description=scenes-4-time-3_75-cotrain \
    ckpt_path=/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/fold-clothes-cotrain/scenes-4-time-3_75-cotrain_2026-01-24_03-58-17/checkpoints/last.ckpt
