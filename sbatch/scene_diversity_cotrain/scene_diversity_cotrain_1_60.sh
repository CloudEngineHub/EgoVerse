#!/bin/bash
#SBATCH --job-name=scene_diversity_cotrain_1_60
#SBATCH --output=sbatch_logs/scene_diversity_cotrain_1_60.out
#SBATCH --error=sbatch_logs/scene_diversity_cotrain_1_60.err
...
python egomimic/trainHydra.py \
    ...
    data=scene_diversity_cotrain/scene_diversity_cotrain_1_60 \
    ...
    description=scenes-1-time-60-cotrain \
    ckpt_path=/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/fold-clothes-cotrain/scenes-1-time-60-cotrain_2026-01-24_03-44-32/checkpoints/last.ckpt
