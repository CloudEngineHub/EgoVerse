#!/bin/bash
#SBATCH --job-name=scene_diversity_cotrain_2_7_5
#SBATCH --output=sbatch_logs/scene_diversity_cotrain_2_7_5.out
#SBATCH --error=sbatch_logs/scene_diversity_cotrain_2_7_5.err
...
python egomimic/trainHydra.py \
    ...
    data=scene_diversity_cotrain/scene_diversity_cotrain_2_7_5 \
    ...
    description=scenes-2-time-7_5-cotrain \
    ckpt_path=/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/fold-clothes-cotrain/scenes-2-time-7_5-cotrain_2026-01-24_03-58-17/checkpoints/last.ckpt
