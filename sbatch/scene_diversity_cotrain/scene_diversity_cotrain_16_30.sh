#!/bin/bash
#SBATCH --job-name=scene_diversity_cotrain_16_30
#SBATCH --output=sbatch_logs/scene_diversity_cotrain_16_30.out
#SBATCH --error=sbatch_logs/scene_diversity_cotrain_16_30.err
...
python egomimic/trainHydra.py \
    ...
    data=scene_diversity_cotrain/scene_diversity_cotrain_16_30 \
    ...
    description=scenes-16-time-30-cotrain \
    ckpt_path=/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/fold-clothes-cotrain/scenes-16-time-30-cotrain_2026-01-23_22-32-22/checkpoints/last.ckpt
