#!/bin/bash
#SBATCH --job-name=scene_diversity_cotrain_4_60
#SBATCH --output=sbatch_logs/scene_diversity_cotrain_4_60.out
#SBATCH --error=sbatch_logs/scene_diversity_cotrain_4_60.err
...
python egomimic/trainHydra.py \
    ...
    data=scene_diversity_cotrain/scene_diversity_cotrain_4_60 \
    ...
    description=scenes-4-time-60-cotrain \
    ckpt_path=/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/fold-clothes-cotrain/scenes-4-time-60-cotrain_2026-01-24_04-02-13/checkpoints/last.ckpt
