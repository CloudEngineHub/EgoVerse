#!/bin/bash
#SBATCH --job-name=scene_diversity_cotrain_2_60
#SBATCH --output=sbatch_logs/scene_diversity_cotrain_2_60.out
#SBATCH --error=sbatch_logs/scene_diversity_cotrain_2_60.err
...
python egomimic/trainHydra.py \
    ...
    ckpt_path=/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/fold-clothes-cotrain/scenes-2-time-60-cotrain_2026-01-24_03-57-24/checkpoints/last.ckpt
