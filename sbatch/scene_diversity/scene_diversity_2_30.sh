...
#     data=scene_diversity/scene_diversity_2_30 \
...
python egomimic/trainHydra.py \
    ...
    train=false \
    validate=true \
    ckpt_path=/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/fold_clothes/scene_diversity/scenes-2-time-30_2026-01-21_21-59-39/everse_scenes_diveristy_fold_clothes/fold-clothes_scenes-2-time-30_2026-01-21_21-59-39/checkpoints/last.ckpt