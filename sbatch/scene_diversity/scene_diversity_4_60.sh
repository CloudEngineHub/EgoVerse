#!/bin/bash
#SBATCH --job-name=scene_diversity_4_60
#SBATCH --output=sbatch_logs/scene_diversity_4_60.out
#SBATCH --error=sbatch_logs/scene_diversity_4_60.err
...
#     data=scene_diversity/scene_diversity_4_60 \
#     logger.wandb.project=everse_scenes_diveristy_fold_clothes \
#     name=fold-clothes \
#     description=scenes-4-time-60
...
python egomimic/trainHydra.py \
    ...
    train=false \
    validate=true \
    ckpt_path="/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/fold_clothes/scene_diversity/scenes-4-time-60_2026-01-21_21-56-36/everse_scenes_diveristy_fold_clothes/fold-clothes_scenes-4-time-60_2026-01-21_21-56-36/checkpoints/last.ckpt"