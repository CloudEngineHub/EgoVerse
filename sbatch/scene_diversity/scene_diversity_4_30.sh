#!/bin/bash
#SBATCH --job-name=scene_diversity_4_30
#SBATCH --output=sbatch_logs/scene_diversity_4_30.out
#SBATCH --error=sbatch_logs/scene_diversity_4_30.err
...
#     data=scene_diversity/scene_diversity_4_30 \
...
python egomimic/trainHydra.py \
    ...
    train=false \
    validate=true \
    ckpt_path="/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/fold_clothes/scene_diversity/scenes-4-time-30_2026-01-26_13-18-12/checkpoints/epoch_epoch\=1999.ckpt"