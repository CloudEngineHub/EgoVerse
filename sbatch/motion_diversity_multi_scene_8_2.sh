#!/bin/bash
#SBATCH --job-name=motion_diversity_multi_scene_8_2
#SBATCH --output=sbatch_logs/motion_diversity_multi_scene_8_2.out
#SBATCH --error=sbatch_logs/motion_diversity_multi_scene_8_2.err
