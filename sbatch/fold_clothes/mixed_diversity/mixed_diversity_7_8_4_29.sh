#!/bin/bash
#SBATCH --job-name=mixed_diversity_7_8_4_29
#SBATCH --output=sbatch_logs/mixed_diversity_7_8_4_29.out
#SBATCH --error=sbatch_logs/mixed_diversity_7_8_4_29.err
...
python egomimic/trainHydra.py \
    ...
    description=7-8-4_29 \
    train=false \
    validate=true \
    ckpt_path="/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/fold-clothes/mixed-diversity-7-8-4_29_2026-01-28_03-34-40/0/checkpoints/epoch_epoch\=1399.ckpt"