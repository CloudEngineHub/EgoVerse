#!/bin/bash
#SBATCH --job-name=mixed_diversity_5_8_6
#SBATCH --output=sbatch_logs/mixed_diversity_5_8_6.out
#SBATCH --error=sbatch_logs/mixed_diversity_5_8_6.err
...
python egomimic/trainHydra.py \
    ...
    train=false \
    validate=true \
    ckpt_path="/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/fold-clothes/mixed-diversity-5-8-6_2026-01-28_03-19-40/0/checkpoints/epoch_epoch\=1399.ckpt"