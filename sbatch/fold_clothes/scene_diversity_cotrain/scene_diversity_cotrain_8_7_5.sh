#!/bin/bash
#SBATCH --job-name=scene_diversity_cotrain_8_7_5
#SBATCH --output=sbatch_logs/scene_diversity_cotrain_8_7_5.out
#SBATCH --error=sbatch_logs/scene_diversity_cotrain_8_7_5.err
...
python egomimic/trainHydra.py \
    ...
    data=scene_diversity_cotrain/scene_diversity_cotrain_8_7_5 \
    ...
    description=scenes-8-time-7_5-cotrain \
    ckpt_path=/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/fold-clothes-cotrain/scenes-8-time-7_5-cotrain_2026-01-24_04-03-20/checkpoints/last.ckpt
