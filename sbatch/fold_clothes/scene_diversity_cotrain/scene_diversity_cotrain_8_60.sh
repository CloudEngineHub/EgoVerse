#!/bin/bash
#SBATCH --job-name=scene_diversity_cotrain_8_60
#SBATCH --output=sbatch_logs/scene_diversity_cotrain_8_60.out
#SBATCH --error=sbatch_logs/scene_diversity_cotrain_8_60.err
...
python egomimic/trainHydra.py \
    ...
    data=scene_diversity_cotrain/scene_diversity_cotrain_8_60 \
    ...
    description=scenes-8-time-60-cotrain \
    ckpt_path=/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/fold-clothes-cotrain-2/scenes-8-time-60-cotrain_2026-01-25_22-20-48/checkpoints/last.ckpt