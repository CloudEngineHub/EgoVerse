#!/bin/bash
#SBATCH --job-name=mixed_diversity_4_8_7_5
#SBATCH --output=sbatch_logs/mixed_diversity_4_8_7_5.out
#SBATCH --error=sbatch_logs/mixed_diversity_4_8_7_5.err
...
python egomimic/trainHydra.py \
    ...
    train=false \
    validate=true \
    ckpt_path="/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/fold_clothes/mixed_diversity/mixed-diversity-4-8-7-5_2026-01-23_02-20-18/checkpoints/epoch_epoch\=1399.ckpt"