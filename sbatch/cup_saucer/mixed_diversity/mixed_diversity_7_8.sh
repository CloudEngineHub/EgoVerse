#!/bin/bash
#SBATCH --job-name=mixed_diversity_7_8
#SBATCH --output=sbatch_logs/mixed_diversity_7_8.out
#SBATCH --error=sbatch_logs/mixed_diversity_7_8.err
...
#     data=cup_saucer/mixed_diversity/mixed_diversity_7_8 \
...
python egomimic/trainHydra.py \
    ...
    train=false \
    validate=true \
    ckpt_path="/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/cup_saucer_mix/7-8_2026-02-03_13-05-09/checkpoints/epoch_epoch\=1399.ckpt"
