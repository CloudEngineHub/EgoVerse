#!/bin/bash
#SBATCH --job-name=mixed_diversity_5_4
#SBATCH --output=sbatch_logs/mixed_diversity_5_4.out
#SBATCH --error=sbatch_logs/mixed_diversity_5_4.err
...
#     data=cup_saucer/mixed_diversity/mixed_diversity_5_4 \
...
python egomimic/trainHydra.py \
    ...
    train=false \
    validate=true \
    ckpt_path="/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/cup_saucer_mix/5-4_2026-02-03_13-03-07/checkpoints/epoch_epoch\=1399.ckpt"
