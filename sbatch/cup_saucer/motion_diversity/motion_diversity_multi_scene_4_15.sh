...
#     data=cup_saucer/motion_diversity/motion_diversity_multi_scene_4_15 \
...
python egomimic/trainHydra.py \
    ...
    train=false \
    validate=true \
    ckpt_path="/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/cup_saucer_motion/4-15_2026-02-03_12-01-59/checkpoints/epoch_epoch\=1399.ckpt"
