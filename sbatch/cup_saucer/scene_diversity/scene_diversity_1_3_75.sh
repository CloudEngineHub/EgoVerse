...
#     data=cup_saucer/scene_diversity/scene_diversity_1_3_75 \
...
python egomimic/trainHydra.py \
    ...
    train=false \
    validate=true \
    ckpt_path="/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/cup_saucer_scene/1-3_75_2026-02-04_22-31-33/checkpoints/epoch_epoch\=1399.ckpt"
