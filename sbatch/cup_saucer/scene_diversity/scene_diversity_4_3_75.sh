...
#     data=cup_saucer/scene_diversity/scene_diversity_4_3_75 \
...
python egomimic/trainHydra.py \
    ...
    train=false \
    validate=true \
    ckpt_path="/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/cup_saucer_scene/4-3_75_2026-02-04_14-09-51/checkpoints/epoch_epoch\=1399.ckpt"
