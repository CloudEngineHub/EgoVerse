...
#     data=cup_saucer/scene_diversity/scene_diversity_16_7_5 \
...
python egomimic/trainHydra.py \
    ...
    train=false \
    validate=true \
    ckpt_path="/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/cup_saucer_scene/16-7_5_2026-02-04_14-07-51/checkpoints/epoch_epoch\=1399.ckpt"
