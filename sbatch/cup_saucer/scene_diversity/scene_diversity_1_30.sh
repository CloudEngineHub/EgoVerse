#!/bin/bash
#SBATCH --job-name=scene_diversity_1_30
#SBATCH --output=sbatch_logs/scene_diversity_1_30.out
#SBATCH --error=sbatch_logs/scene_diversity_1_30.err
...
#     data=cup_saucer/scene_diversity/scene_diversity_1_30 \
...
python egomimic/trainHydra.py \
    ...
    train=false \
    validate=true \
    ckpt_path="/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/cup_saucer_scene/1-30_2026-02-04_14-21-09/checkpoints/epoch_epoch\=1399.ckpt"
