#!/bin/bash
#SBATCH --job-name=scene_diversity_16_3_75
#SBATCH --output=sbatch_logs/scene_diversity_16_3_75.out
#SBATCH --error=sbatch_logs/scene_diversity_16_3_75.err
...
#     data=cup_saucer/scene_diversity/scene_diversity_16_3_75 \
...
python egomimic/trainHydra.py \
    ...
    train=false \
    validate=true \
    ckpt_path="/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/cup_saucer_scene/16-3_75_2026-02-04_14-07-47/checkpoints/epoch_epoch\=1399.ckpt"
