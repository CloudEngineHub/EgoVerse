...
#     data=cup_saucer/scene_diversity/scene_diversity_2_15 \
...
python egomimic/trainHydra.py \
    ...
    train=false \
    validate=true \
    ckpt_path="/coc/cedarp-dxu345-0/bli678/EgoVerse/logs/cup_saucer_scene/2-15_2026-02-04_22-28-26/checkpoints/epoch_epoch\=1399.ckpt"
