#!/bin/bash
#SBATCH --job-name=motion_diversity_multi_scene_8_1
#SBATCH --output=sbatch_logs/motion_diversity_multi_scene_8_1.out
#SBATCH --error=sbatch_logs/motion_diversity_multi_scene_8_1.err
