#!/bin/bash
#SBATCH --job-name=T_cup_BC+1ID_cam
#SBATCH --account=a144
#SBATCH --output=/iopsstor/scratch/cscs/jiaqchen/egomim_out/zeta/50hz/BC+1ID/cup/slurm-cup-%j.out
#SBATCH --error=/iopsstor/scratch/cscs/jiaqchen/egomim_out/zeta/50hz/BC+1ID/cup/slurm-cup-%j.err
...
##################### EXPERIMENT CONFIG ####################
export VARIANT="BC+1ID"
export DATA_CONFIG="cup/multi_data_BC+1ID"
# Data config: /capstor/store/cscs/swissai/a144/jiaqchen/egoverse/EgoVerse/egomimic/hydra_configs/data/cup/multi_data_BC+1ID.yaml
