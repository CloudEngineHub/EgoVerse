...
export hydra_run_dir=/iopsstor/scratch/cscs/jiaqchen/egomim_out/multi_node_v2/50hz/${debug_folder}${EXPERIMENT}_recheck_split/${task}/${task}_${frame_type}_small_dataset
export dataset_root=/iopsstor/scratch/cscs/jiaqchen/data/EGOMIM/srl_data/output/release_2_0/50hz/pg1_cl75_clout100/cup_lerobot_base_frame
# export dataset_root=/iopsstor/scratch/cscs/jiaqchen/data/EGOMIM/srl_data/output/release_2_0/50hz/${EXPERIMENT}/DEBUG/${task}_lerobot_${frame_type}
...
export WANDB_RUN_ID=${task}_${frame_type}_${description}_${PG_CL_EXPERIMENT}_${arm}_${job_id_for_wandb}
