#!/bin/bash
#SBATCH --job-name=T_cup_BC_cam
#SBATCH --account=a144
#SBATCH --output=/iopsstor/scratch/cscs/jiaqchen/egomim_out/zeta/50hz/BC/cup/slurm-cup-%j.out
#SBATCH --error=/iopsstor/scratch/cscs/jiaqchen/egomim_out/zeta/50hz/BC/cup/slurm-cup-%j.err
