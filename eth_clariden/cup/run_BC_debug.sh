#!/bin/bash
#SBATCH --job-name=T_cup_BC_DEBUG_cam
#SBATCH --account=a144
#SBATCH --output=/iopsstor/scratch/cscs/jiaqchen/egomim_out/zeta/50hz/DEBUG/BC/cup/slurm-cup-%j.out
#SBATCH --error=/iopsstor/scratch/cscs/jiaqchen/egomim_out/zeta/50hz/DEBUG/BC/cup/slurm-cup-%j.err
...
# Parse command-line arguments (--new-wandb, --skip-preflight)
for arg in "$@"; do
    case $arg in
