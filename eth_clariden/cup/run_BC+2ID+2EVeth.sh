#!/bin/bash
#SBATCH --job-name=T_cup_BC+2ID+2EVeth_cam
#SBATCH --account=a144
#SBATCH --output=/iopsstor/scratch/cscs/jiaqchen/egomim_out/zeta/50hz/BC+2ID+2EVeth/cup/slurm-cup-%j.out
#SBATCH --error=/iopsstor/scratch/cscs/jiaqchen/egomim_out/zeta/50hz/BC+2ID+2EVeth/cup/slurm-cup-%j.err
...
##################### EXPERIMENT CONFIG ####################
export VARIANT="BC+2ID+2EVeth"
export DATA_CONFIG="cup/multi_data_BC+2ID+2EVeth"
# Data config: /capstor/store/cscs/swissai/a144/jiaqchen/egoverse/EgoVerse/egomimic/hydra_configs/data/cup/multi_data_BC+2ID+2EVeth.yaml
