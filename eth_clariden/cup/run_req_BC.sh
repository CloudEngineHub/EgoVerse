...
export hydra_run_dir=/iopsstor/scratch/cscs/jiaqchen/egomim_out/multi_node_v2/50hz/${debug_folder}BC${RESTART}/${EXPERIMENT}/${task}/${task}_${frame_type}
...
# export ckpt_path='/iopsstor/scratch/cscs/jiaqchen/egomim_out/multi_node_v2/50hz/pg1_cl75_clout100_recheck_split/cup/cup_base_frame/checkpoints/epoch_epoch=499.ckpt' # 1461487
